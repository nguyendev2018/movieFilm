...
// Khởi tạo biểu đồ
    ...
    function () {
        ...
        // Ẩn nhãn chú thích(legends) nếu không phải là biểu đồ tròn
        myChart.config.options.plugins.legend.display = chartType !==
        'pie' && chartType !== 'doughnut' ? false : true;
        myChart.update();
    });
</script>